  ...
  return (
    <section className="min-h-screen py-20 bg-[#0a0203] text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        {/* Header */}
        <div className="mb-12">
          <Link href="/" className="inline-flex items-center gap-2 text-gray-500 hover:text-white text-xs font-bold uppercase tracking-widest transition-colors mb-6 group">
